...
/* Тот же указатель, что у русского поиска, и та же обвязка. Язык движку не
   ...
   По нему движок и отбирает находки, и говорит сам — «18 matches», «Nothing
   found», «Show more»; имя раздела над находкой приходит из указателя, и там
   оно тоже английское. Ни одного слова выдачи здесь не написано. */
SiteSearch.mount({
    input: 'q',
    status: 'status',
    results: 'results',
