#!/usr/bin/env python3
"""Озвучивает термины словаря: деванагари -> ksh/ta/audio/<ключ>.mp3.
...
Тот же скрипт, что у `tools/sv/`: отличаются только два пути.
...
PAGE = os.path.normpath(os.path.join(HERE, '..', '..', 'ksh', 'ta', 'glossary', 'index.md'))
OUT = os.path.normpath(os.path.join(HERE, '..', '..', 'ksh', 'ta', 'audio'))
