...
произношения. Голос читает по правилам хинди и склонен проглатывать конечное
краткое «а»: `bheda` выходит «бхед» вместо «бхеда». Осторожнее с
придыхательными, ретрофлексными и долготами.*
...
def row(term, place):
    ...
    return ('<tr id="t-%s" data-alias="%s">'
            ...
            % (words.keyof(term), term.alias or term.ru.lower(),
               ...
               term.deva, term.gloss, where(place)))
