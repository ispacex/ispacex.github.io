...
const WANT = [
	...
	// Адрес здесь без `.html` — тот, каким главу зовут ссылки сайта. Раньше
	// палитра вела на `/dance/ns-ch12.html`: адрес она берёт из `page.url`, а
	// тот отдавал имя файла (VS-52).
	['натьяшастра глава 12', '/dance/ns-ch12'],
	['натьяшастра словарь', '/dance/glossary'],
