...
Считается по всем переведённым главам. Помет под строфами глав 1–4 гуще: там
переведено изложение Габриэля, и одно санскритское слово он разбирает на
полстраницы. В главах 5–23 перевод сделан прямо с санскрита, помета при каждом
слове ровно одна — и столбец «где в главах» ведёт туда, где термин стоит в самой
строфе.
...
пришлось: помет 11 438, и чаще всего в них попадаются связки — `ca` «и» двести
сорок шесть раз. Здесь оставлено то, обо что читатель спотыкается.*
...
устройства, и самые частые слова — разряды: `tattva`, `pada`, `varga`. Семь
воспринимающих, пять состояний сознания под тремя именами каждое, пятьдесят букв
по частям тела, четыре яйца Брахмы. С пятой главы, где начинается сам путь,
к ним встают `śakti`, `yoga` и `mantra` — по сто с лишним раз каждое.*

*Последний столбец ведёт в те строфы, где термин звучит гуще всего. Считан он по
всем переведённым главам — и по тем, где переведено изложение Габриэля (1–4), и
по тем, где перевод сделан прямо с санскрита (с пятой). У нескольких статей
столбец пуст — `pramātṛ`, `pramāṇa`, `svātantrya`, `śaktipāta` разбираются в
пояснениях по-русски, а в санскритской помете не стоят ни разу. Словарь шире
подстрочника, и должен быть шире.*
