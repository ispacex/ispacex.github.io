...
<p><input type="search" id="q" placeholder="например: раса, шактипата, anuttara, парус" autocomplete="off" spellcheck="false" /></p>
...
*Текст «Теории плавания под парусами» в указатель не входит: книга лежит в
[просмотрщиках](/ship/) как PDF и DjVu, а поиск читает страницы сайта. Найдётся
раздел книги и справочные материалы к ней, но не слова из самой книги.*
